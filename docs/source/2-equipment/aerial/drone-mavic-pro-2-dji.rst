...
The DJI Mavic Pro is a compact folding quadcopter with a stabilised 3-axis gimbal camera used to capture aerial photos and 4K video for missions like inspection, mapping, and cinematography. It is operated via a remote controller and the DJI GO 4 mobile app, with features such as Return-to-Home and obstacle sensing to support safer flight operations.
...
.. list-table::
   ...
   * - **Mobility**
     - Aerial
   * - **Resolution**
     - Video up to 4K/30 fps; stills 12 MP (4000×3000)
   * - **Maximum speed**
     - 18 m/s
...
``drone`` · ``UAV`` · ``aerial photography`` · ``survey`` · ``inspection`` · ``outdoor`` · ``portable`` · ``camera`` · ``indoor``
